...
# Visualise a decision tree or trees from ensembles and outputs a jpeg image
...
# rule extraction from a tree model with filtering criterions based on recall/precision on a given dataset
# allow extract all paths of a tree with no filtering
...
# Evaluates performance of rule extraction
...
# Converts rules to tree diagram
